...
@Component({
  selector: 'app-show-indexation',
  templateUrl: './show-indexation.component.html',
  styleUrls: ['./show-indexation.component.scss'],
})
export class ShowIndexationComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ShowIndexationComponent>
  ) {
  ...
  GetWallArea(SpaceID: any) {
    ...
    return Area - (DoorArea + WindowArea);
  }
