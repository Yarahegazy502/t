...
@Component({
  selector: 'app-dostep-three',
  templateUrl: './dostep-three.component.html',
  styleUrls: ['./dostep-three.component.scss']
})
export class DOStepThreeComponent implements OnInit {
