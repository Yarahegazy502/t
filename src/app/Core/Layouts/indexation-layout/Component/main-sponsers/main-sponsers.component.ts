...
@Component({
  selector: 'app-main-sponsers',
  templateUrl: './main-sponsers.component.html',
  styleUrls: ['./main-sponsers.component.scss']
})
export class MainSponsersComponent implements OnInit {
